package in.co.library.managment.ctl;
...
import in.co.library.managment.form.ChangePasswordForm;
import in.co.library.managment.form.ForgetPasswordForm;
import in.co.library.managment.form.LoginForm;
import in.co.library.managment.form.MyProfileForm;
import in.co.library.managment.form.UserRegistrationForm;
import in.co.library.managment.service.UserServiceInt;
import in.co.library.managment.util.DataUtility;
	...
	public String submit(@RequestParam("profilePic") MultipartFile file,@RequestParam String operation, @Valid @ModelAttribute("form") UserRegistrationForm form,
		...
		try {
			if (OP_SAVE.equalsIgnoreCase(form.getOperation())) {
				...
				dto.setLibraryCodel(DataUtility.getRandom());
				service.add(dto);
