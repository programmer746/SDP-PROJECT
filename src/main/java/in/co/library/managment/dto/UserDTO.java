package in.co.library.managment.dto;
...
public class UserDTO extends BaseDTO {
	...
	private long libraryCodel;
	
	

	public long getLibraryCodel() {
		return libraryCodel;
	}

	public void setLibraryCodel(long libraryCodel) {
		this.libraryCodel = libraryCodel;
	}
